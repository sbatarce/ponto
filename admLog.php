...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body onload="javascript:Titulo( '<h4>admLog.php</h4>' );">
		<?php
    ...
    <div class='row input-append linha' style='margin-top: 10px; margin-left:30px;'>
      <h4>Periodo</h4>
      De <input type="text" id="dtinic" class="input-small" style="width: 10%" />
      ate <input type="text" id="dtterm" class="input-small" style="width: 10%" />
      <button id="obter" type="button" onclick="javascript:Registro()" 
							class="btn btn-success">Registro</button>	<br><br>
			<h4>Pessoa</h4>
			<!-- combobox de Aparelhos em uso -->
			<input style='width:50%;' class='input-small depen' 
						 id="pessoas" title="Escolha uma das pessoas abaixo"/>
			</div>
			<div id="presen" class='row linha' style='margin-top: 10px; margin-left:30px;'>
			</div>
